...
import osfexport as exporter


# from osfio_export_tool import exporter as exporter
# Import your package
# from osfio_export_tool import exporter as exporter
...
with st.form("export_form"):
   ...
   dryrun = True  # For testing purposes, set to True
   usetest = False
           ...
           try:
               ...
               if not root_nodes:
                   ...
                   with tempfile.TemporaryDirectory() as tmpdir:
                       pdf_obj, pdf_path = exporter.write_pdf(
                           projects,
                           root_idx=root_idx,
                           folder=tmpdir
                       )
               ...
               st.error(f"❌ An error occurred: {str(e.message)}")
